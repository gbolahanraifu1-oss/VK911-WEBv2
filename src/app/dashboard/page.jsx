    ...
    <div style={{ padding: "32px", maxWidth: "1400px" }}>
      ...
      >
        <StatCard
          ...
          value={isLoading ? "—" : stats?.totalCommands || 214}
          sub="200+ available plugins"
          color="#00ff88"
          icon="⌘"
        />
        <StatCard
          label="Messages Today"
          value={isLoading ? "—" : stats?.messagesToday || 0}
          sub="Processed by bot"
          color="#6366f1"
          icon="✉"
        />
        <StatCard
          label="Active Sessions"
          value={isLoading ? "—" : sessions?.length || 0}
        ...
        <StatCard
          label="Commands Used"
          value={isLoading ? "—" : stats?.commandsUsed || 0}
          sub="Last 24 hours"
          color="#f59e0b"
          icon="◈"
        />
        <StatCard
          label="Success Rate"
          value={isLoading ? "—" : `${stats?.successRate || 99}%`}
          sub="Command success"
          color="#ec4899"
          icon="✓"
        />
      ...
      >
        ...
        >
          ...
          <ResponsiveContainer width="100%" height={180}>
            <BarChart
              data={cmdData.length ? cmdData : defaultCmdData}
              layout="vertical"
            >
              <CartesianGrid
                strokeDasharray="3 3"
        ...
        >
          ...
          >
            <ResponsiveContainer width={150} height={150}>
              <PieChart>
                <Pie
                  data={catData.length ? catData : defaultCatData}
                  cx="50%"
                  cy="50%"
                  innerRadius={45}
                  outerRadius={70}
...
const activityLog = [
  { time: "14:32", type: "cmd", msg: ".ytmp4 executed — 120910912@g.us" },
  {
    time: "14:31",
    type: "cmd",
    msg: ".sticker executed — 25476221@s.whatsapp.net",
  },
