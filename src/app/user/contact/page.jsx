...
const socials = [
  ...
  { name: "WhatsApp Channel", icon: "💬", color: "#25d366", handle: "ᴍᴀᴅᴀʀᴀ x-ᴍᴅ Official", url: "https://whatsapp.com/channel/0029VaYpQHFHXotnpcTf3C3T", desc: "Bot updates, tips & announcements" },
  ...
  return (
    <div>
      <div style={{ marginBottom: "32px" }}>
        ...
        <p style={{ color: "#475569", fontSize: "13px", margin: 0 }}>Get help or follow ᴍᴀᴅᴀʀᴀ x-ᴍᴅ on social media</p>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div style={{ background: "#0f0f1a", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "16px", padding: "24px" }}>
            <h3 style={{ fontSize: "13px", fontWeight: "700", color: "#94a3b8", textTransform: "uppercase", letterSpacing: "0.8px", margin: "0 0 18px 0" }}>⬦ Follow ᴍᴀᴅᴀʀᴀ x-ᴍᴅ</h3>
