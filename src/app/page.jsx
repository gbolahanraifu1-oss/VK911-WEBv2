...
export default function LoginPage() {
  ...
  return (
    <div style={{
      minHeight: "100vh",
      background: "radial-gradient(ellipse at 20% 50%, #0d1f12 0%, #080810 50%, #0a0518 100%)",
      display: "flex",
      alignItems: "center",
      ...
      <div style={{ position: "absolute", inset: 0, pointerEvents: "none" }}>
        {particles.map((p) => (
          <div key={p.id} style={{
            ...
            height: `${p.size}px`,
            borderRadius: "50%",
            background: p.id % 3 === 0 ? "#00ff88" : p.id % 3 === 1 ? "#6366f1" : "#22d3ee",
            opacity: 0.12,
            animation: `float-${p.id % 5} ${p.speed}s infinite linear`,
          }} />
        ))}
      </div>
      ...
      <div style={{ width: "100%", maxWidth: "420px", padding: "0 20px", zIndex: 10 }}>
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          <div style={{
            ...
            marginBottom: "20px", boxShadow: "0 0 40px rgba(0,255,136,0.3)",
          }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: "13px", color: "#64748b", margin: "0 0 28px 0" }}>
            Access your bot management panel
          </p>
          ...
          <form onSubmit={handleLogin}>
            <div style={{ marginBottom: "18px" }}>
              ...
              <input
                ...
                style={{
                  ...
                  padding: "12px 16px", fontSize: "14px", color: "#e2e8f0",
            ...
            <button
              ...
              style={{
                ...
                background: loading ? "rgba(0,255,136,0.3)" : "linear-gradient(135deg, #00ff88, #06b6d4)",
                border: "none", borderRadius: "10px", fontSize: "14px", fontWeight: "700",
                color: "#080810", cursor: loading ? "not-allowed" : "pointer",
                boxShadow: loading ? "none" : "0 0 20px rgba(0,255,136,0.3)",
              }}
            >{loading ? "— Authenticating..." : "→ Access Dashboard"}</button>
          </form>

          <p style={{ textAlign: "center", fontSize: "11px", color: "#334155", marginTop: "24px", marginBottom: 0 }}>
