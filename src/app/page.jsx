  ...
  useEffect(() => {
    const token =
      typeof window !== "undefined"
        ? localStorage.getItem("vk911_token")
        : null;
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background:
          "radial-gradient(ellipse at 20% 50%, #0d1f12 0%, #080810 50%, #0a0518 100%)",
        display: "flex",
        alignItems: "center",
    ...
    >
      ...
      >
        ...
        >
          ...
          <p
            style={{ fontSize: "13px", color: "#64748b", margin: "0 0 28px 0" }}
          >
      ...
      <style jsx global>{`
        ...
        *{box-sizing:border-box}
        ::-webkit-scrollbar{width:6px}::-webkit-scrollbar-track{background:#0a0a15}::-webkit-scrollbar-thumb{background:#1e293b;border-radius:3px}
      `}</style>
    </div>
  );
}
